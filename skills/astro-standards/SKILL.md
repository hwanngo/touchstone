...
Full standard: **`standards/frameworks/astro.md`** (layers on `standards/languages/typescript.md`).
Load-bearing rules:
...
## Defer
- Island internals → `../../standards/frameworks/react.md` / `../../standards/frameworks/svelte.md` / `../../standards/frameworks/vue.md`; language/tsconfig/test-runner → `../../standards/languages/typescript.md`; a11y (astro check warnings + axe gate) → `../../standards/practices/accessibility.md`; Core Web Vitals budgets → `../../standards/practices/performance.md`; secrets/auth → `../../standards/practices/security.md`.
