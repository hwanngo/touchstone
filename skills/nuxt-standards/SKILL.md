...
Full standard: **`standards/frameworks/nuxt.md`** (layers on `standards/languages/typescript.md`; carries
condensed Vue 3 essentials inline — the full Vue rules live in `standards/frameworks/vue.md`). Rules:
...
## Defer
- API contract → `../../standards/design/api-design.md`; authN/authZ → `../../standards/practices/app-security.md`; language/tsconfig → `../../standards/languages/typescript.md`.
