...
Full standard: **`standards/frameworks/fastapi.md`** (layers on `standards/languages/python.md`). Rules:
...
- API contract/errors → `../../standards/design/api-design.md`; DB + Alembic → `../../standards/platform/database.md`; authN/authZ → `../../standards/practices/app-security.md`; async correctness → `../../standards/languages/python.md`.
