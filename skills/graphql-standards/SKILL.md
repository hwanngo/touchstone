...
rules to [api-design.md](../../standards/design/api-design.md), failure mechanics to
[resilience.md](../../standards/design/resilience.md), and authN/authZ to
[app-security.md](../../standards/practices/app-security.md). Load-bearing rules:
...
- **Field-level authz is deny-by-default, enforced in the resolver per object** (IDOR/BOLA) — not the gateway, not UI hiding (see app-security.md).
