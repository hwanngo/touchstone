...
Full standard: **`standards/frameworks/litestar.md`** (layers on `languages/python.md`). Rules:
...
## Defer
- API contract → `../design/api-design.md`; DB → `../platform/database.md`; authN/authZ model → `../practices/app-security.md`; async → `../languages/python.md`.
